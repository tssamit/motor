...
<html lang="en">
                        ...
                        <div class="row collapse" id="addnew" >
                            <div class="col-xl-12">
                                <div class="card mb-4">
                                    ...
                                    <form action="pages/action-dealer.php"  enctype="multipart/form-data" method="post">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-select" name="user_type_code" id="user_type_code" required>
                                                            ...
                                                            <?php
                                                            $sqltpin = $db->query("SELECT act_id,act_name,act_permission,act_icon_permission,act_sts FROM `acc_type` WHERE `act_id` IN (5)");
                                        ...
                                        <div class="table-responsive">
                                            <table class="table dt-responsive" id="datatablesSimple" style="font-size: 13px;">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $sl = 0;
                                                    $data = $db->query("SELECT * FROM `vw_master_user`  WHERE a_usertype IN (5) ORDER BY a_name ASC");
    ...
    <!--                                                                <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-id=</?= $value->a_id; ?> data-bs-target="#changePWD" title="Change Password"><i class="fa fa-key" aria-hidden="true"></i> PWD</button>-->
                                                                ...
                                                                <a href="pages/action-dealer.php?submit=usupdt&id=<?= $value->a_id; ?>&st=<?php
                                                                if ($value->a_status == '1') {
                                                                    echo '0';
                                                                } else {
                                                                    echo '1';
        ...
        <script>
            ...
            $(document).ready(function () {
                $('#myModalPermission').on('show.bs.modal', function (e) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: 'fetch_permissiond.php', //Here you will fetch records
