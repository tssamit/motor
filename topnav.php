        ...
        <ul class="navbar-nav navbar-align">
            ...
            <li class="nav-item dropdown">
                <a class="nav-icon pe-md-0 dropdown-toggle" href="#" data-bs-toggle="dropdown">
                    <img src="img/avatars/avatar.png" class="avatar img-fluid rounded" alt="User" />
                </a>
                <div class="dropdown-menu dropdown-menu-end">
                    <a class="dropdown-item" href="profile"><i class="align-middle me-1" data-feather="user"></i> <?= (!empty($rowuser->a_username)) ? ucwords($rowuser->a_username) : 'User '; ?> Profile</a>
                    <!--                    <a class="dropdown-item" href="#"><i class="align-middle me-1" data-feather="pie-chart"></i> Analytics</a>-->
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="pages-settings.html"><i class="align-middle me-1" data-feather="settings"></i> Settings &
                        Privacy</a>
                    <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#myModalpwd"><i class="align-middle me-1" data-feather="key"></i> Change Password</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="pages/loginvalidate.php?submit=logout">Log out</a>
                </div>
            </li>
        </ul>
    </div>
</nav>
<div class="modal fade" id="myModalpwd" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal row g-3" role="form" action="pages/action-pwd.php" enctype="multipart/form-data" method="post">


                    <div class="col-md-12">
                        <label for="currentPassword" class="form-label">Current Password</label>

                        <input name="cur_password" type="password" class="form-control" id="currentPassword" required>
                    ...
                    <div class="col-md-12">
                        ...
                        <input name="confirm_a_pwd" type="password" class="form-control" id="renewPassword" required>
